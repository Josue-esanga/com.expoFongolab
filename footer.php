<footer class="w-full bg-black mt-12 pl-2">
        <div class="sm:flex sm:justify-between w-full bg-black text-white pt-12 grid grid-cols-2">
          ...
          <div class="sm:w-1/4 w-[97%] pr-2 col-span-2">
          ...
          <div class="w-1/4 sm:hidden flex">
            <p class="ml-5 text-[25px] pl-25 py-3 font-semibold">Akazilink</p>
          </div>
        </div>
        <hr class="bg-gray-600 text-gray-600 w-[96%] ml-5" />
        <div class="text-white flex justify-between sm:px-6 px-0 mt-6 pb-6">
          <p class="font-bold text-[18px] sm:pl-0">Solutions</p>
          <div class="">
            <button
            ...
            <button
              class="bg-white text-black py-1.5 rounded-xs text-[13px] font-semibold px-2 pr-1"
            >
