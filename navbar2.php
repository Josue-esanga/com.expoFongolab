<nav
      ...
      >
        ...
        <ul
          id="menu"
          class="sm:flex sm:justify-center hidden items-start justify-start pl-2 rounded-[8px] sm:static sm:flex-row flex-col sm:gap-12 absolute sm:right-0 right-40 top-[10.5vh] sm:h-[10vh] h-[30vh] sm:bg-white bg-white w-[200px] gap-6 sm:items-center sm:w-full mt-2"
        >
          <li
            id="Empljob"
        ...
        <div id="miniProfile" class="resultat h-[50px] pr-2 cursor-pointer">
          <img
            id="miniProfilePic"
            src="./pictures/47.jpg"
            class="rounded-[50%] w-[50px] h-[50px] flex items-center justify-center"
            alt="Profil"
          />
        </div>
      </nav>