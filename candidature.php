    ...
    <section class="sm:pl-7 pl-2 mt-[12vh]">
      <div class="pt-5">
        <h2 class="text-[16px] font-semibold">
          Prim's bienvenue dans votre suivi de candidatures !
        </h2>
        <p class="text-gray-500">
          Actualisez votre avancement, triez vos jobs, échangez avec les
          recruteurs... Vous avez la main.
        </p>
      </div>
      <ul class="flex gap-5 font-semibold mt-6 mb-3">
        <li class="cursor-pointer border-b-[3px]">Candidatures en cours</li>
        <li id="passées" class="cursor-pointer hover:border-b-[3px]">
          Candidatures passées
        </li>
      </ul>
      <hr class="border-gray-300" />
      <div class="sm:flex flex-wrap w-full grid grid-cols-2 gap-10">
        <div class="sm:w-[20%] w-1/2">
          <div>
            <h1 class="font-semibold">SAUVEGARDE</h1>
            <hr class="border-gray-300" />
          </div>
          <h3 class="font-semibold mt-3">Vous n'avez pas encore de job</h3>
          <p class="text-gray-500">
            Sauvgardez un job, postulez ou ajoutez un job externe pour
            commencer.
          </p>
          <button
            class="bg-amber-300 font-semibold text-white sm:px-2 px-0.5 cursor-pointer py-1.5 rounded mt-3 flex items-center gap-2"
          >
            <svg
        ...
        <div class="sm:w-[20%] w-1/2">
          <div>
            <h1 class="font-semibold">CANDIDATURES ENVOYEES</h1>
            <hr class="border-gray-300" />
          </div>
          <!-- <h3>Vous n'avez pas encore de job</h3>
                <p>Sauvgardez un job, postulez ou ajoutez un job externe pour commencer.</p>
                <button class="bg-amber-300 font-semibold text-white px-2 cursor-pointer py-1.5 rounded mt-3 flex items-center gap-2">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 24 24"><path d="M12 5v14m7-7H5" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
                  Ajouter un job
                </button> -->
        </div>
        <div class="sm:w-[20%] w-1/2 sm:h-auto h-[20vh]">
          <div>
            <h1 class="font-semibold">ENTRETIEN EN COURS</h1>
            <hr class="border-gray-300" />
          </div>
          <!-- <h3>Vous n'avez pas encore de job</h3>
                <p>Sauvgardez un job, postulez ou ajoutez un job externe pour commencer.</p>
        ...
        <div class="w-[20%]">
          <div>
            <h1 class="font-semibold">PROPOSITION D'EMBAUCHE</h1>
            <hr class="border-gray-300" />
          </div>
          <!-- <h3>Vous n'avez pas encore de job</h3>
                <p>Sauvgardez un job, postulez ou ajoutez un job externe pour commencer.</p>
